...
class Option:
    def __init__(self, keyword: str, type = str, desc: str = '', default_value = None, allow_values: list = None, allow_none: bool = False) -> None:
        self._key = keyword
        self._type = type
        self._desc = desc
...
class BooleanOption(Option):
    def __init__(self, keyword: str, desc: str = '', defval: bool = False) -> None:
        super().__init__(keyword, bool, desc, defval,  [True, False, 0, 1, 'True', 'False', '0', '1', 'Yes', 'No'])

    def _internal_validate(self, val: str) -> bool:
        return super()._internal_validate(val)
    
class IntegerOption(Option):
    def __init__(self, keyword: str, desc: str = '', defval: int = 0, allow_values: list = None) -> None:
        super().__init__(keyword, int, desc, defval, allow_values)

    def _internal_validate(self, val: str) -> int:
        return super()._internal_validate(val)

class StringOption(Option):
    def __init__(self, keyword: str, desc: str = '', defval: str = '', allow_values: list = None) -> None:
        super().__init__(keyword, str, desc, defval, allow_values)
...
if __name__=="__main__":
    ...
    _input: StringOption = StringOption("--in", "Input file which contains words will be merged with results", None)
    broker: enchant.Broker = enchant.Broker()
    list_languages: list = broker.list_languages()
    _language: StringOption = StringOption("--lang", "Language name use to validate words", "en_US", list_languages)
    option_list : list = [
        _verbose,
        _fork,
        _input,
